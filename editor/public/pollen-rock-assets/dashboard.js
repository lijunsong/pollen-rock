...
var _lijunsong$pollen_rock$Dashboard$update = F2(
	function (msg, model) {
		...
		if (_p0.ctor === 'OnLocationChange') {
			var newRoute = _lijunsong$pollen_rock$Models$parsePath(_p0._0.pathname);
			return {
				ctor: '_Tuple2',
			...
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{fsListDirectory: _p0._0}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		}
	});
var _lijunsong$pollen_rock$Dashboard$initialModel = function (route) {
	return {route: route, fsListDirectory: _krisajenkins$remotedata$RemoteData$NotAsked};
};
var _lijunsong$pollen_rock$Dashboard$init = function (location) {
	var currentRoute = _lijunsong$pollen_rock$Models$parsePath(location.pathname);
	var msg = function () {
		var _p1 = currentRoute;
		if (_p1.ctor === 'DashboardRoute') {
			return _lijunsong$pollen_rock$Dashboard$listDirectory(_p1._0);
		} else {
	...
	return {
		ctor: '_Tuple2',
		_0: _lijunsong$pollen_rock$Dashboard$initialModel(currentRoute),
		_1: msg
	};
};
var _lijunsong$pollen_rock$Dashboard$main = A2(
	...
	{init: _lijunsong$pollen_rock$Dashboard$init, view: _lijunsong$pollen_rock$View_Dashboard$view, update: _lijunsong$pollen_rock$Dashboard$update, subscriptions: _lijunsong$pollen_rock$Dashboard$subscriptions})();
