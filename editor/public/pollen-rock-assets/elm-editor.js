...
var _lijunsong$pollen_rock$Editor$defaultNotifyTimeout = 3000;
...
var _lijunsong$pollen_rock$Editor$notifyInfo = _elm_lang$core$Native_Platform.outgoingPort(
	'notifyInfo',
	function (v) {
		return [v._0, v._1];
	});
var _lijunsong$pollen_rock$Editor$notifyError = _elm_lang$core$Native_Platform.outgoingPort(
	'notifyError',
	function (v) {
		return [v._0, v._1];
	});
				...
				if (_p10.ctor === 'Success') {
					if (!_elm_lang$core$Native_Utils.eq(_p10._0.errno, 0)) {
						return {
							ctor: '_Tuple2',
							_0: model,
							_1: _lijunsong$pollen_rock$Editor$notifyError(
								{ctor: '_Tuple2', _0: 'Failed to load config', _1: _lijunsong$pollen_rock$Editor$defaultNotifyTimeout})
						};
					} else {
						...
						return {
							...
							_1: _elm_lang$core$Platform_Cmd$batch(
								{
									ctor: '::',
									_0: _lijunsong$pollen_rock$Editor$updatePollenSetup(newModel.pollenSetup),
									_1: {
										ctor: '::',
										_0: _lijunsong$pollen_rock$Editor$notifyInfo(
											{ctor: '_Tuple2', _0: 'Ready to Rock!', _1: _lijunsong$pollen_rock$Editor$defaultNotifyTimeout}),
										_1: {ctor: '[]'}
									}
								})
						};
...
var _lijunsong$pollen_rock$Editor$main = _elm_lang$html$Html$programWithFlags(
	{init: _lijunsong$pollen_rock$Editor$init, view: _lijunsong$pollen_rock$View$editorView, update: _lijunsong$pollen_rock$Editor$update, subscriptions: _lijunsong$pollen_rock$Editor$subscriptions})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (filePath) {
			return _elm_lang$core$Json_Decode$succeed(
